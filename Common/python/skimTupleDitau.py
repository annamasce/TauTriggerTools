...
ROOT.gInterpreter.Declare('#include "{}TauTagAndProbe/interface/PyInterface.h"'.format('/afs/cern.ch/work/l/lwezenbe/TauPOG/CMSSW_10_2_18/src/TauTriggerTools/'))
...
for channel_name, channel_id in channels.items():
    ...
    df = df.Define(pass_branch, '''TriggerMatchProvider::GetDefault().PassDitau({}, run, tau_eta, tau_phi, hlt_accept, {},
