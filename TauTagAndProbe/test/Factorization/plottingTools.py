...
def plotClosure(observed, predicted, xtitle, ytitle, DataName, destination, yLog = False, additionalInfo = None):
    GeneralSettings()
...
def draw2DHist(h, xlabel, ylabel, output, option="ETextColz", x_log = False, y_log = False):
    ...
    h.GetXaxis().SetRange(40, 100) 
    h.GetYaxis().SetRange(40, 100) 
    h.Draw(option)
